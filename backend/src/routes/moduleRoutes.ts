...
import { updateHRDetails, updateITDetails, updateAssetDetails, updateDispatchDetails, updateQADetails, updateKekaDetails, getAvailableLicenses, uploadCredentialSheet, validateAsset, uploadGetPass } from '../controllers/moduleController';
...
router.get('/inventory/licenses', requireRole(['IT_ADMIN']), getAvailableLicenses);
router.get('/asset/validate', requireRole(['ASSET']), validateAsset);
